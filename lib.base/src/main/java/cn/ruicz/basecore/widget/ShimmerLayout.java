...
public class ShimmerLayout extends FrameLayout {
    ...
    public ShimmerLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            shimmerBackgroundColor = a.getColor(R.styleable.ShimmerLayout_shimmer_background_color, 0);
    ...
    public void onViewAdded(View child) {
        ...
        if (shimmerBackgroundColor != 0) setChilcBackground(child);
    }
    ...
    private void setChilcBackground(View child){
        if (child instanceof ViewGroup){
            ViewGroup viewGroup = (ViewGroup) child;
            for (int i = 0; i < viewGroup.getChildCount(); i++){
                setChilcBackground(viewGroup.getChildAt(i));
            }
        }else{
            child.setBackgroundColor(shimmerBackgroundColor);
        }
    }
