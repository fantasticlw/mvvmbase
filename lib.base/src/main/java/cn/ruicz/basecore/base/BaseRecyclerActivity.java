...
public abstract class BaseRecyclerActivity<V extends FragmentRecyclerBinding, VM extends BaseViewModel, T> extends BaseActivity<V, VM> implements SwipeRefreshLayout.OnRefreshListener, OnItemClickListener<T>, OnItemLongClickListner<T>, OnLoadMoreListener {
