...
public abstract class BaseRecyclerFragment<V extends FragmentRecyclerBinding, VM extends BaseViewModel, T> extends BaseFragment<V, VM> implements SwipeRefreshLayout.OnRefreshListener, OnItemClickListener<T>, OnItemLongClickListner<T>, OnLoadMoreListener {
    ...
    protected RecyclerView.ItemDecoration createItemDecoration() {
        ...
        return new RecyclerViewDecoration(getContext(), VERTICAL, 1, R.color.conversation_gray, 0);
    }
    ...
    public SimpleObserver getSubscriber() {
        ...
        return new SimpleObserver<>(getContext(), action1, createCompleted(), createError());
    }
