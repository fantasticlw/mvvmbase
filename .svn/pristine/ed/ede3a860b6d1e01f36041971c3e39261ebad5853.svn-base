...
public abstract class BaseRecyclerFragment<T> extends BaseFragment<FragmentRecyclerBinding, BaseViewModel> implements SwipeRefreshLayout.OnRefreshListener, OnItemClickListener<T>, OnItemLongClickListner<T>, OnLoadMoreListener {
